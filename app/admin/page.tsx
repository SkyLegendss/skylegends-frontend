      ...
      <div className="bg-[#141414] border-b border-white/10 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" className="font-black text-white text-sm tracking-[0.15em] uppercase">
              Sky Legends
            </Link>
          ...
          <div className="flex gap-2 items-center">
            <button
              onClick={exportCSV}
              className="text-xs px-4 py-2 border border-white/10 text-white/50 hover:border-white/30 hover:text-white transition-colors duration-200"
            >
              Export CSV
            </button>
            <Link href="/order"
